...
"padding-left: 20px;")
        ...
        self.btn_exit.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
...
"}")
        ...
        self.btn_add_new.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
...
"}")
        ...
        self.btn_del.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
