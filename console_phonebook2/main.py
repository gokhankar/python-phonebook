...
def contact_detail(choice):
    with open("contacts.txt", "r", encoding="utf-8") as file:
        ...
        while True:
            try:
                select = int(input(f'1) Edit contact "{line_list[choice - 1]["name"]} {line_list[choice-1]["surname"]}"'
...
def contact_detail_tr(choice):
    with open("contacts.txt", "r", encoding="utf-8") as file:
        ...
        while True:
            try:
                select = int(input(f'1) Kişiyi Güncelle"{line_list[choice-1]["name"]} {line_list[choice-1]["surname"]}"'
